 ...
 */
const analyzeRateLimit = (0, express_rate_limit_1.default)({
...
const validateAnalysisInput = (req, res, next) => {
    const { url, content, metadata } = req.body;
 ...
 * - URL validation
 */
router.post('/analyze', analyzeRateLimit, validateAnalysisInput, async (req, res) => {
    try {
        const { url, content, metadata } = req.body;
 ...
 */
router.post('/analyze/stream', analyzeRateLimit, validateAnalysisInput, async (req, res) => {
    try {
        const { url, content, metadata } = req.body;
...
//# sourceMappingURL=analyzer_secure.js.map